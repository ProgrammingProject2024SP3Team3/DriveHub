...
namespace Admin.Controllers
{
    ...
    public class InvoicesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("InvoiceNumber,BookingId,DateTime,Amount")] Invoice invoice)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("InvoiceNumber,BookingId,DateTime,Amount")] Invoice invoice)
        {
