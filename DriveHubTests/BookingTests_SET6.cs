...
{
    /// <summary>
    /// User A has an expired Iron Stallion
    /// </summary>
    public class BookingTests_SET6
    {
        BookingTestFixtures Fixture;

        [Fact]
        public async Task Set6_UserA_Extend_ShouldReturnError()
        {
        ...
        [Fact]
        public async Task Set6_UserB_Extend_ShouldReturnError()
        {
            Fixture = new BookingTestFixtures(6, "userb");
        ...
        [Fact]
        public async Task Set6_UserA_PrintInvoice_ShouldReturnNotFound()
        {
            Fixture = new BookingTestFixtures(6, "usera");
        ...
        [Fact]
        public async Task Set6_UserA_PrintReport_ShouldReturnNotFound()
        {
            Fixture = new BookingTestFixtures(6, "usera");
        ...
        [Fact]
        public async Task Set6_UserB_PrintInvoice_ShouldReturnNotFound()
        {
            Fixture = new BookingTestFixtures(6, "userb");
        ...
        [Fact]
        public async Task Set6_UserB_PrintReport_ShouldReturnNotFound()
        {
            Fixture = new BookingTestFixtures(6, "userb");
